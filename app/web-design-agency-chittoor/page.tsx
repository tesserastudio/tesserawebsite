...
const capabilities = [
  {
    ...
    desc: "We craft custom user interfaces and digital brand systems that look elegant, work smoothly, and project immediate trust. Zero generic templates."
  },
  {
    icon: "⚡",
  ...
  },
  {
    ...
    desc: "AI receptionists, WhatsApp lead pathways, and smart CRM follow-ups built directly into your website's primary lead funnel."
  },
  {
    icon: "📐",
...
export default function ChittoorWebDesignPage() {
  return (
    <>
        ...
        <div className="site-container relative z-10 text-center">
          <Reveal>
            ...
            <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              ...
              <Link href="/website-development-chittoor" className="rounded-full border border-white/[0.1] bg-white/[0.04] px-8 py-4 text-center font-semibold text-white transition hover:bg-white/[0.08] w-full sm:w-auto">
                Explore Website Dev
              </Link>
            </div>
